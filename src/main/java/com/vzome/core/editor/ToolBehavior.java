...
public class ToolBehavior {
	...
	// Input behaviors
	public static final int selectInputs_MASK = SHIFT_MASK;
    public static final int hideInputs_MASK = CTRL_MASK;
	// Output behaviors
    public static final int deselectOutputs_MASK = ALT_MASK;
    public static final int justSelectExistingOutputs_MASK = META_MASK;
	...
	// There is intentionally no method to change the modifiers after the c'tor. 
	...
	public boolean selectInputs()		{ return hasAllMaskBitsSet( selectInputs_MASK ); }
    public boolean hideInputs()			{ return hasAllMaskBitsSet( hideInputs_MASK ); }
    public boolean deselectOutputs()	{ return hasAllMaskBitsSet( deselectOutputs_MASK ); }
    public boolean justSelectExisting()	{ return hasAllMaskBitsSet(justSelectExistingOutputs_MASK ); }
	
	// convenience methods
	public boolean hasAnyModifiers()		{ return ( modifierFlags != 0 ); }
	public boolean hasAnyInputModifiers()	{ return hasAnyMaskBitsSet( selectInputs_MASK | hideInputs_MASK ); }
	public boolean hasAnyOutputModifiers()	{ return hasAnyMaskBitsSet( deselectOutputs_MASK | justSelectExistingOutputs_MASK ); }
