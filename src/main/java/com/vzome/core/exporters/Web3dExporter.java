...
public class Web3dExporter extends Exporter3d
{
	...
	public Web3dExporter( Color background, RenderedModel model )
	{
	    super( null, null, null, model );
	    field = model .getField();
	    this .background = background;
	}


	public void doExport( File directoryUnused, Writer writer, Dimension screenSizeUnused ) throws IOException
	{
