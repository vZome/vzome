...
public class NewPolytopesDialog extends EscapeDialog
{
    private final JCheckBox[] renderCheckboxes = new JCheckBox[4];
    private final QuaternionPanel quaternionPanel;
    
    public NewPolytopesDialog( Frame frame, final Controller controller )
    {
        super( frame, "Generate a 3D or 4D Polytope", true );
	...
	content .add( quaternionPanel, BorderLayout.CENTER );
		...
		public void actionPerformed( ActionEvent e )
		{
		    NewPolytopesDialog.this .setVisible( false );
		}
	    } );
        buttons .add( cancel );
