...
public class FibonacciTest {
    ...
    public final <T extends Fields.Element<T> & Comparable<T>> void testReverseableFibonacciSeries(Class<T> clazz, int reps, T first, T second)
    {
        ...
        T[] reversed = (T[]) Array.newInstance(clazz, fibs.size());
    ...
    public void testVariableFibonacci() {
        {
            ...
            List<?> fibs = varableFibonacci(BigRational::dividedBy, 12, new BigRational("23/-31"), new BigRational("-51/-7"), new BigRational("-11/13"), new BigRational("17/19"));
            fibs = varableFibonacci(BigRational::times, 12, new BigRational("23/-31"), new BigRational("-51/-7"), new BigRational("-11/13"), new BigRational("17/19"));
            fibs = varableFibonacci(BigRational::plus, 12, new BigRational("23/-31"), new BigRational("-51/-7"), new BigRational("-11/13"), new BigRational("17/19"));
            fibs = varableFibonacci(BigRational::minus, 12, new BigRational("23/-31"), new BigRational("-51/-7"), new BigRational("-11/13"), new BigRational("17/19"));
        }
        {
