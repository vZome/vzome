...
public class OpenScadMeshExporter extends GeometryExporter
{
	...
	public void doExport( File directory, Writer writer, int height, int width ) throws IOException
	{
        ...
        String prelude = this.getBoilerplate( "com/vzome/core/exporters/mesh-prelude.scad" );
        ...
        String postlude = this.getBoilerplate( "com/vzome/core/exporters/mesh-postlude.scad" );
