...
public class IcosahedralSymmetryPerspective extends AbstractSymmetryPerspective {
    ...
    protected IcosahedralSymmetryPerspective(IcosahedralSymmetry symm) {
        ...
        final AbstractShapes noTwist = new ExportedVEFShapes( null, "noTwist", "no-twist 121 zone", null, this.symmetry );
        ...
        final AbstractShapes vienne = new ExportedVEFShapes( null, "vienne", "Vienne 121 zone", null, this.symmetry );
