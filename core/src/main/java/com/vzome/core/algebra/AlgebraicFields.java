...
public class AlgebraicFields {
     ...
     * @return an array containing the coeffucients of the named field. 
    ...
    public static double[] getCoefficients(String fieldName) {
        ...
        case PentagonField.FIELD_NAME:
            coefficients = PentagonField.getCoefficients();
            break;
            
        case RootTwoField.FIELD_NAME:
            coefficients = RootTwoField.getCoefficients();
            break;
            
        case RootThreeField.FIELD_NAME:
            coefficients = RootThreeField.getCoefficients();
            break;
            
        case HeptagonField.FIELD_NAME:
            coefficients = HeptagonField.getCoefficients();
            break;
            
        case SnubDodecField.FIELD_NAME:
            coefficients = SnubDodecField.getCoefficients();
            break;
