...
public abstract class AbstractAlgebraicField implements AlgebraicField
{
    ...
    protected BigRational[] reciprocal( BigRational[] fieldElement )
    {
        ...
        return (rank == length) 
                ? reciprocalFactors 
                : onReciprocalRankDefficient(rank, reciprocal, reciprocalFactors);
    }
     ...
     */
    protected BigRational[] onReciprocalRankDefficient(int rank, BigRational[][] reciprocal, BigRational[] reciprocalFactors) {
