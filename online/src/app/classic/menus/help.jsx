...
export const HelpMenu = () =>
{
  ...
  const fetchStarter = resource => () => guard(() =>
  {
    ...
    return (
      <Menu label="Help">
        <LinkItem href='https://docs.vzome.com/quick-start.html' label='Quick Start' />
        ...
        <LinkItem label='vZome Home'                 href='https://www.vzome.com' />
        <LinkItem label='Sharing vZome Files Online' href='https://docs.vzome.com/sharing.html' />
        ...
        <SubMenu label="Misc. Online Documentation">
          ...
          <LinkItem label='Capturing Vector Graphics'      href='https://docs.vzome.com/capture-vector-graphics.html' />
        </SubMenu>
